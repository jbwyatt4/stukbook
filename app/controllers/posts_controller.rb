class PostsController < ApplicationController
  ...
  def create
    ...
    if @post.save
      ...
      redirect_to redirect_to user_path(@post.user.username), notice: "Something went wrong"
    end
  end
  ...
  def update
    if @post.update(post_params)
      ...
      redirect_to redirect_to post_path(@post.user.username), notice: "Something went wrong"
    end
  end
